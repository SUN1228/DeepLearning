...
def FCN8(nclasses,input_height=416,input_width=688,vgg_level=3):
    ...
    x=MaxPooling2D((2,2),srides=(2,2),name='block2_pool')(x)
    f2=x
    ...
    x=MaxPooling2D((2,2),srides=(2,2),name='block3_pool')(x)
    f3=x
    ...
    x=MaxPooling2D((2,2),srides=(2,2),name='block4_pool')(x)
    f4=x
    ...
    x=MaxPooling2D((2,2),srides=(2,2),name='block5_pool')(x)
    f5=x
    ...
    o2=f4
    o2=Conv2D(nclasses,(1,1),kernel_initializer='he_normal')(o)
